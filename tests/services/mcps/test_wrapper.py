...
Target: 100% branch coverage for src/lionherd/services/mcps/wrapper.py
...
from lionherd.services.mcps.wrapper import MCPConnectionPool
...
class TestCreateClient:
    ...
    async def test_create_client_no_url_or_command(self):
        ...
        with pytest.raises(ValueError, match="Config must have either 'url' or 'command' key"):
