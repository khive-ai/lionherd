...
Target: 100% branch coverage for src/lionherd/services/types/registry.py
...
class TestRegistryBasicOperations:
    ...
    def test_register_update_replaces(self):
        ...
        backend1.version = "1.0.0"
        backend2.version = "2.0.0"
...
class TestRegistryDiscovery:
    ...
    def test_list_by_tag(self):
        ...
        backend1 = MockBackend(config={"provider": "test", "name": "prod1"})
        backend1.tags = {"production", "api"}
        backend2 = MockBackend(config={"provider": "test", "name": "prod2"})
        backend2.tags = {"production", "worker"}
        backend3 = MockBackend(config={"provider": "test", "name": "dev1"})
        backend3.tags = {"development"}
