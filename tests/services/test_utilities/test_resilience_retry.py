...
"""Tests for retry logic using lionherd-core primitives."""
...
class TestRetryConfig:
    ...
    def test_default_values(self):
        ...
        from lionherd.services.utilities.resilience import CircuitBreakerOpenError
...
class TestRetryWithBackoff:
    ...
    async def test_success_after_retries(self):
        ...
        with patch("lionherd.services.utilities.resilience.sleep", new_callable=AsyncMock):
    ...
    async def test_all_retries_exhausted(self):
        ...
        with (
            patch("lionherd.services.utilities.resilience.sleep", new_callable=AsyncMock),
    ...
    async def test_exponential_backoff_delays(self):
        ...
        with patch("lionherd.services.utilities.resilience.sleep", mock_sleep):
            result = await retry_with_backoff(
                mock_func,
                max_retries=3,
                initial_delay=1.0,
